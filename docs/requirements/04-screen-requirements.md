...
- 当日一緒にいたぬいぐるみの概要
- 全面表示の日別地図
- 同行したぬいぐるみのテーマカラー（複数体はグラデーション）を内側と枠線に使った円形の投稿ピン
- 場所と時刻がある投稿地点を時系列に結ぶ、緩やかな曲線の点線
- 下端が常に見え、上下スワイプまたはハンドル操作で開閉できるドロワー内の当日投稿一覧
- 画面右下の「＋」新規投稿ボタン
- 地図上の本アイコンによる「きょうの日記」ボタン
- ドロワー展開時は「＋」と本アイコンをドロワーに重ならない位置へ移動する
- ドロワー格納時も「＋」と本アイコンを見えているドロワー部分に重ねない
...
| 条件                   | 表示例                                               | 強調               |
| ---------------------- | ---------------------------------------------------- | ------------------ |
| 案内時刻前・未作成     | 本アイコン（読み上げ: きょうの日記を見る）           | 通常               |
| 案内時刻以降・未作成   | 本アイコン（読み上げ: きょうの日記を書く）           | 強調               |
| 作成済み               | 本アイコン（読み上げ: きょうの日記を見る・編集する） | 通常または完了状態 |
| 作成済みで投稿更新あり | 本アイコン（読み上げ: きょうの日記を見る・編集する） | 注意表示可         |
